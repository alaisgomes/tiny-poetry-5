"""
Django settings for tiny_poetry_5 project.
...
ROOT_URLCONF = 'tiny_poetry_5.urls'
...
WSGI_APPLICATION = 'tiny_poetry_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Tiny Poetry Support <support@tiny-poetry-5.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tiny_poetry_5 API",
    "DESCRIPTION": "API documentation for tiny_poetry_5 App",
    "VERSION": "v1",
}
